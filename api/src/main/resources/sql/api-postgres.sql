INSERT INTO question (created_at, modified_at, question)
VALUES (NOW(), NOW(), '새로운 프로젝트에 착수합니다. 팀원들이 다양한 아이디어를 내놓습니다. 당신은?'),
...
INSERT INTO option (score, question_id, answer, personality_type)
VALUES (1, 1, '모두 모여 브레인스토밍! 다양한 의견 환영!', 'EXTROVERSION'),
...
INSERT INTO image (original_file_name, store_file_name, url)
VALUES ('karina.jpg', 'd290f1ee-6c54-4b01-90e6-d701748f0851.jpg',
        'https://webti-imagebucket.s3.eu-north-1.amazonaws.com/karina.jpg'),
       ('karina.jpg', 'd290f1ee-6c54-4b01-90e6-d701748f0851.jpg',
        'https://webti-imagebucket.s3.eu-north-1.amazonaws.com/karina.jpg'),
       ('karina.jpg', 'd290f1ee-6c54-4b01-90e6-d701748f0851.jpg',
        'https://webti-imagebucket.s3.eu-north-1.amazonaws.com/karina.jpg'),
       ('karina.jpg', 'd290f1ee-6c54-4b01-90e6-d701748f0851.jpg',
...
VALUES (NOW(), NOW(),
       ...
       (NOW(), NOW(),
        ...
        'ESFP', '창의적인 인터페이스 디자이너형 프론트엔드 개발자', 6),
       (NOW(), NOW(),
        ...
        'ENFP', '혁신적인 UX/UI 전문가형 프론트엔드 개발자', 7),
       (NOW(), NOW(),
       ...
       (NOW(), NOW(),
        ...
        'ESTP', '유연하고 즉흥적인 개발자형 풀스택 개발자', 16);

INSERT INTO statistic (created_at, modified_at, developer_profile_id, count, match_count)
VALUES (NOW(), NOW(), (SELECT id FROM web_developer_profile WHERE mbti_type = 'ISTJ'), 0, 0),
